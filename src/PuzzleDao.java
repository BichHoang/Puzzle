...
public class PuzzleDao extends Frame implements ActionListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (b1.getLabel().equals("") && b2.getLabel().equals("15") && b3.getLabel().equals("14")
				&& b4.getLabel().equals("13") && b5.getLabel().equals("12") && b6.getLabel().equals("11")
				&& b7.getLabel().equals("10") && b8.getLabel().equals("9") && b9.getLabel().equals("8")
				&& b10.getLabel().equals("7") && b11.getLabel().equals("6") && b12.getLabel().equals("5")
				&& b13.getLabel().equals("4") && b14.getLabel().equals("3") && b15.getLabel().equals("2")
				&& b16.getLabel().equals("1")) {
